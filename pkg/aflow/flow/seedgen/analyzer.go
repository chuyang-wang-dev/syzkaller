...
var SeedgenAnalyzer = aflow.LLMTool[AnalyzerQuery]{
	...
	Instruction: "You are a strict codebase researcher. Your task is to execute the exact " +
		...
		"2. Syzkaller Repository: Use the 'read-syz-spec' tool to read syzlang descriptions (sys.txt files), test seeds, " +
		"and syzkaller executor code (executor/). DO NOT try to use codesearch or grepper for syzkaller files.\n" +
		...
		"Once you have found the necessary information, return a clean, concise summary of the findings " +
		"in your final reply." +
